...
const timerContainerCountdown = document.querySelector('.timer-container__countdown');
...
const timerFunc = function() {
  ...
  if (time === 0) {
    // Show notification
    if (isNotificationAllowed) new Notification("Timer", { body: "Time is up!", icon: "/clock.png" })
    clearInterval(timer);
